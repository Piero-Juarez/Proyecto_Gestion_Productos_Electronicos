        ...
        <div class="row flex-grow-1">
			...
			<div class="col-xl-11 bg-ligth d-flex flex-column align-items-center justify-content-center mt-5 mb-5">
				...
				<div class="w-100 container">
					...
					<!--
					<div class="mt-4">
						<label for="nombreCargo" class="form-label">Agregar Nuevo Cargo</label>
						<div class="d-flex gap-3">
							<input type="text" class="form-control" id="nombreCargo" name="txtNombreCargo" placeholder="Nombre del cargo" style="max-width: 320px; width: 100%;" />
							<button class="btn btn-dark"
									onclick="window.location.href='${pageContext.request.contextPath}/ConfigurationServlet?type=agregarEntidad&data-clave=cargoTrabajador'">
								Agregar Cargo <i class="bi bi-plus-lg ps-1"></i>
							</button>
						</div>
					</div>
					<div class="table-responsive mt-4">
						<table id="" class="w-100 display table table-bordered table-hover text-center">
							...
							<tbody>
								...
								<%
									List<Cargo> listadoCargos = (List<Cargo>) session.getAttribute("listadoCargos");
									
									if(listadoCargos != null) {
										for(Cargo item: listadoCargos) {
								%>
								
								<tr>
									<td><%= item.getIdCargo() %></td>
									<td><%= item.getNombreCargo() %></td>
									<td>
										<button class="btn btn-dark btn-modificar"
												data-id="<%= item.getIdCargo() %>"
												data-value="<%= item.getNombreCargo() %>"
												data-clave="cargoTrabajador"
				...
				<div class="w-100 container mt-5">
					<h2>Sección Venta</h2>
					<div class="mt-4">
						<label for="nombreEstadoVenta" class="form-label">Agregar Nuevo Estado de venta</label>
						<div class="d-flex gap-3">
							<input type="text" class="form-control" id="nombreEstadoVenta" placeholder="Nombre del estado" style="max-width: 320px; width: 100%;" />
							<button class="btn btn-dark">
								Agregar Estado de Venta <i class="bi bi-plus-lg ps-1"></i>
							</button>
						</div>
					</div>
					<div class="table-responsive mt-4">
					...
					<div class="mt-5">
						<label for="nombreMetodoPago" class="form-label">Agregar Nuevo Método de Pago</label>
						<div class="d-flex gap-3">
							<input type="text" class="form-control" id="nombreMetodoPago" placeholder="Nombre del método de pago" style="max-width: 320px; width: 100%;" />
							<button class="btn btn-dark">
								Agregar Método de Pago <i class="bi bi-plus-lg ps-1"></i>
							</button>
						</div>
					</div>
					<div class="table-responsive mt-4">
