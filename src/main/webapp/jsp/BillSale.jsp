	...
	<div class="container-fluid vh-100 d-flex flex-column" data-barba="container" data-barba-namespace="home">
        <div class="row flex-grow-1">
			...
			<div class="col-xl-11 bg-ligth d-flex flex-column align-items-center justify-content-center mt-5 mb-5">
				...
				<h1 class="mb-2">${decisionUsuario} Nº F-${ultimoIdFactura}</h1>
				        ...
				        <div class="col-12 col-lg-6 mb-3 mb-lg-0">
					        ...
					        <div class="mb-5">
						        ...
						        <div class="row mb-3">
						            <div class="col">
						                <label>RUC</label>
						                <input class="form-control" id="txtRucCliente" type="text" name="txtRucCliente" value="${rucClienteObtenido}" placeholder="RUC del cliente">
						            </div>
						            <div class="col">
						            	<label>Buscar</label>
						                <button onclick="window.location.href='${pageContext.request.contextPath}/SalesServlet?service=encontrarClientePorRUC&rucCliente=' + document.getElementById('txtRucCliente').value" type="button" class="btn btn-dark w-100">
						                	Buscar Cliente
						        ...
						        <div class="row mb-3">
						        	<div class="col">
						                ...
						                <input class="form-control" type="text" name="txtRazonSocialCliente" value="${razonSocialClienteObtenido}" placeholder="Esperando cliente..." readonly="readonly">
						            </div>
						            <div class="col">
						                <label>Nombre Comercial</label>
						                <input class="form-control" type="text" name="txtNombreComercialCliente" value="${nombreComercialClienteObtenido}" placeholder="Esperando cliente..." readonly="readonly">
						            </div>
						        </div>
						        ...
						        <div class="row mb-6">
						            <div class="col">
						                ...
						                <input class="form-control" type="text" name="txtDireccionFiscalCliente" value="${direccionFiscalClienteObtenido}" placeholder="Esperando cliente..." readonly="readonly">
						            </div>
						        </div>
						    </div>
					        <!-- FIN SECCIÓN CLIENTE -->
